...
var teacher_1 = __importDefault(require("../../../services/ceo/logins/teacher"));
var teacherlogins = new teacher_1["default"]();
var TeacherLoginController = /** @class */ (function () {
    function TeacherLoginController() {
    }
    TeacherLoginController.prototype.setTeacherLogin = function (req, res) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, teacherlogins.findTeacherLogin(ceologs.login)];
                    case 1:
    ...
    TeacherLoginController.prototype.teacherLogin = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, teacherlogins.findTeacherLogin(login)];
                    case 1:
                        logsin = _b.sent();
                        if (!logsin) {
    ...
    TeacherLoginController.prototype.findAllTeacherLogins = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, teacherlogins.findAllTeacherLogin()
    ...
    TeacherLoginController.prototype.deleteTeacherLoginById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    TeacherLoginController.prototype.findByTeacherID = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports["default"] = TeacherLoginController;
