...
router["delete"]('/news/:id', ceo_1.publish.deletePublishedById);
// category routes
router.post('/category', ceo_1.publish.createCategory);
router.get('/categories/only', ceo_1.publish.getAllCategories);
router.get('/categories', ceo_1.publish.getAllCategoryWithNews),
    router["delete"]('/category/:id', ceo_1.publish.deleteCategory);
// ceoLogin routes
